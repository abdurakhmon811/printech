...
class BlogPost(models.Model):
    ...
    picture_1 = models.ImageField(upload_to='user_loaded_images')
    picture_2 = models.ImageField(upload_to='user_loaded_images', null=True, blank=True)
    picture_3 = models.ImageField(upload_to='user_loaded_images', null=True, blank=True)
...
class Book(models.Model):
    ...
    picture = models.ImageField(null=True, blank=True, upload_to='user_loaded_images')
...
class News(models.Model):
    ...
    subtitle_2 = models.CharField(max_length=100, null=True, blank=True, default=None)
    subtitle_3 = models.CharField(max_length=100, null=True, blank=True, default=None)
    picture_1 = models.ImageField(upload_to='user_loaded_images', null=True)
    picture_2 = models.ImageField(null=True, blank=True, upload_to='user_loaded_images')
    picture_3 = models.ImageField(null=True, blank=True, upload_to='user_loaded_images')
...
class Resource(models.Model):
    ...
    amount_used = models.DecimalField(max_digits=65, decimal_places=2, null=True, blank=True)
    user = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT)
